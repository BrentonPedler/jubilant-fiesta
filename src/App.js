...
function App() {
  ...
  useEffect(() => {
    ...
    dbRef.on('value', (response) => {
      ...
      for (let property in data) {
        // push each book name into new array

        // was array of string but now it's an object with id's:
        newState.push({
  ...
  const removeBook = (whatToRemove) => {
    ...
    // use 2 new firebase method to remove an item
